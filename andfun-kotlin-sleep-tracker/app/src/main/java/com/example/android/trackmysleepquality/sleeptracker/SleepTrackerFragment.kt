...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val sleepTrackerViewModelFactory = SleepTrackerViewModel.Factory(
        ...
        sleepTrackerViewModel.navigateToSleepQualityEvent.observe(viewLifecycleOwner, Observer { sleepNight ->
            sleepNight?.let {
                this.findNavController().navigate(
                        SleepTrackerFragmentDirections.actionSleepTrackerFragmentToSleepQualityFragment(sleepNight.id)
                )
        ...
        sleepTrackerViewModel.navigateToSleepDetailEvent.observe(viewLifecycleOwner, Observer { nightId ->
            nightId?.let {
                this.findNavController().navigate(
